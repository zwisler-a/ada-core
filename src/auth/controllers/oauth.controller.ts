...
export class OAuth2Controller {
    ...
    tokenExchange(
        ...
        if (grant_type == 'authorization_code') {
            ...
            if (authorizationCode.redirect_uri != redirect_uri) throw new UnauthorizedException("invalid redirect");
        ...
        if (grant_type == 'refresh_token') {
            const refreshTokenPayload: RefreshTokenPayload = this.jwt.verify(refresh_token)
            const accessTokenPayload: AccessTokenPayload = {
